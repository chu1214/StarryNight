...
public class ConstellationViewerVR : MonoBehaviourPun, IPunObservable
{
    // 별자리 CSV 데이터
    ...
    public RotatingControllerVR rotatingController;
    ...
    void Start()
    {
        ...
        // GameObject RotatateControllerOJB = GameObject.Find("RotatingController");
        rotatingController = FindObjectOfType<RotatingControllerVR>();
        Debug.Log("로테이팅 컨트롤러 : "+rotatingController);
        Rotating(currentCity);
    }
